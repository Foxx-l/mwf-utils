...
/**
 * The match the rotation is currently pointing at: the next scheduled event, or
 * the one in progress. An event stays "current" for LIVE_WINDOW_HOURS after its
 * start time so features keep showing tonight's map during the match instead of
 * jumping to next week the moment it kicks off.
 *
